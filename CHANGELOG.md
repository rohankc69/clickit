...
- Browsing image history no longer holds full-resolution screenshots in memory. Thumbnails are decoded small with ImageIO and cached, so a handful of screenshots costs a few megabytes of RAM rather than hundreds
